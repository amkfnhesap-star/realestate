      ...
      <section className="bg-brand-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <div className="hidden lg:block absolute top-8 start-0 end-0 h-px bg-gold-200 z-0 mx-16" />
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 relative z-10">
              {STEPS.map((step) => (
                <div key={step.num} className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm text-center">
                  <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-gold-400 text-white font-bold text-sm flex items-center justify-center">
                    {step.num}
                  </div>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {WHY_ITEMS.map((item) => (
              <div key={item.title} className="bg-brand-50 rounded-2xl p-6 border border-slate-100">
      ...
      <section className="bg-brand-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <Link
              href="/properties"
              className="inline-block border-2 border-brand-800 text-brand-800 px-8 py-3.5 rounded-xl font-medium hover:bg-brand-800 hover:text-white transition-colors"
            >
              {t('cta.browse')}
            </Link>
          </div>
